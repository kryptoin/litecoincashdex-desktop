...
set(DEX_COMPANY "LitecoinCash Brasil")
set(DEX_WEBSITE "https://litecoincash.com.br/")
set(DEX_VERSION "0.9.0")
set(DEX_SUPPORT_PAGE "https://litecoincash.com.br/comunidade.php")
set(DEX_DISCORD "https://discord.com/invite/F2nZXnW")
set(DEX_TWITTER "https://twitter.com/LitecoinCash")
set(DEX_PRIMARY_COIN "LCC-segwit")                                                  ## Main coin of the DEX, will be enabled by default and will be the default left ticker for trading
...
set(DEX_REPOSITORY_OWNER "LitecoinCashBrasil")
set(DEX_REPOSITORY_NAME "litecoincashdex-desktop")
set(DEX_CHECKSUM_API_URL "https://komodo.earth/static/checksum.json")
if (APPLE)
    set(DEX_APPDATA_FOLDER "litecoincashdex")
else ()
    set(DEX_APPDATA_FOLDER "litecoincashdex")
endif ()
if (UNIX AND NOT APPLE)
    set(DEX_LINUX_APP_ID "litecoincashdex.desktop")
endif ()
