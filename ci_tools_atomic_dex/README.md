# Cheetahdex Wallet Pro alpha build instructions
...
## Create Cheetahdex Wallet Pro Installer
...
- Build Cheetahdex Wallet Pro `./ci_tools_atomic_dex build release`
