...
namespace
{
    ...
    openrates_client()
    {
        ...
        static t_http_client_ptr client = std::make_unique<web::http::client::http_client>(FROM_STD_STR("https://defi-stats.komodo.earth"), g_openrates_cfg);
        return client;
    }
    ...
    async_fetch_fiat_rates()
    {
        ...
        return openrates_client()->request(req, g_token_source.get_token());
    }
