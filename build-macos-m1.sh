...
if command -v brew >/dev/null 2>&1; then
  ...
  export CMAKE_PREFIX_PATH="${HOMEBREW_PREFIX}:${QT_PREFIX}:${HOMEBREW_PREFIX}/opt/boost@1.85:${HOMEBREW_PREFIX}/opt/boost@1.85/lib/cmake:${HOMEBREW_PREFIX}/opt/entt/lib/EnTT/cmake"
